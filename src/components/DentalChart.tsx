        ...
        <div className="bg-white h-full overflow-y-auto">
          ...
          <div className="p-4 space-y-6">
            ...
            <div className="border rounded-xl p-4 bg-gray-50">
              ...
              <div className="grid grid-cols-2 gap-2">
                {["buccal", "lingual", "mesial", "distal", "occlusal", "entire"].map(surface => {
                  const surfaceColors = {
                    buccal: "#f59e0b",
                    lingual: "#8b5cf6",
                    mesial: "#3b82f6",
                  ...
                  return (
                    ...
                    >
                      <div 
                        ...
                        style={{ backgroundColor: surfaceColors[surface as keyof typeof surfaceColors] }}
                      >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {["Caries", "Filling", "Extraction", "Root Canal"].map(action => (
                  <button
                    key={action}
                    type="button"
                  ...
                  {teeth.map(tooth => {
                    ...
                    return (
                      <button
                        key={tooth.number}
                        type="button"
                        onClick={() => isMobile ? openToothDetails(tooth) : handleToothToggle(tooth.number)}
                      ...
                      >
                        <div className={`w-10 h-10 flex items-center justify-center rounded-full text-sm font-bold mb-2 ${
                          isSelected ? 'bg-primary-foreground text-primary' : 'bg-gray-100 text-gray-700'
                        }`}>
                          {tooth.number}
                        </div>
      ...
      <div className="relative w-full" ref={dropdownRef}>
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            {selectedTeeth.length > 0 && selectionMode === "multiple" && !isMobile && (
              <Button
                onClick={onOpenMultiToothModal}
                size="sm"
